      ...
      <div className="about-content">
        <div className="profile">
          ...
          <p className="profile-description">
            I have decided to change my career path and pursue my passion for
            software development. In 2022, I resigned from my secure job and
            invested time and money in comprehensive training to become a
            Full-Stack Web & App Developer.
            <br />
            <br />
            Through this investment in my professional future, I aim to expand
            my skills and prepare myself for new opportunities in the field of
